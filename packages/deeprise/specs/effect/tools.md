...
Practical reference for the current tool-migration state in `packages/deeprise`.
...
Tool tests should use the existing Effect helpers in `packages/deeprise/test/lib/effect.ts`:
